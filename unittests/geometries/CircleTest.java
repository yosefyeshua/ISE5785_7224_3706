...
class CircleTest {
    ...
    void calculateIntersectionsHelper() {
        ...
        List<Intersection> intersections = c.calculateIntersectionsHelper(r);
        ...
        assertEquals(new Point(0.5, 0.5, 1), intersections.getFirst().point, "Intersection point is incorrect");

        // TC02: Ray goes outside the circle
        r = new Ray(new Point(2, 2, 0), new Vector(0, 0, 1));
        assertNull(c.calculateIntersectionsHelper(r), "Expected no intersections");
        ...
        intersections = c.calculateIntersectionsHelper(r);
        assertNotNull(intersections, "Expected intersections to be found");
        assertEquals(1, intersections.size(), "Expected one intersection point");
        assertEquals(new Point(0, 0, 1), intersections.getFirst().point, "Intersection point is incorrect");
    }
}